  ...
  >
    <div class="statistics-layout">
      ...
      <el-row :gutter="20" style="padding: 10px">
        <el-col :span="8">
          <div style="color: #909399;font-size: 18px;float: left">最近<ins v-text="day"/>天共注册用户:&nbsp;&nbsp;<ins v-text="userCount"/>人</div>
        </el-col>
        <el-col :span="8">
            <div align="center">
              <el-date-picker
        ...
        <el-col :span="8">
            <el-button v-if="userData!==null" type="text" style="font-size: 18px;padding: 0px;float: right" @click="details">查看用户</el-button >
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
    ...
    >
      ...
      >
        ...
        >
          <template slot-scope="props">
            {{ props.row.loginName|propData('暂无') }}
          </template>
        </el-table-column>
        <el-table-column
          prop="name"
        ...
        >
          <template slot-scope="props">
            {{ props.row.community|propData('暂无') }}
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
<script>
import { fetchData, pageData } from '@/api/dataUser'
export default {
  name: 'Index',
  data() {
    return {
  ...
  methods: {
    ...
    fetchData(val) {
      ...
      if (val !== undefined && val.prop === `loginName`) {
        if (val.order === undefined) {
          name = 'login_name'
          order = 'desc'
        }
